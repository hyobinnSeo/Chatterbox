const mikePence = {
    ...
    - "주여, 제게 헌법을 수호할 힘과 저들의 지랄을 견딜 인내를 주시옵소서."
    - "오늘의 일정은... 헌법 연구, 기도, 그리고 벨 양에게 헌법의 중요성을 다시 한번 설명하기. 가장 힘든 일정이 마지막에 있군."
    벨에게 말할 때:
    - "헌법 공부에 집중해주십시오. 틱톡 댄스는 내각 합류를 위한 필수 과목이 아닙니다."
    ...
    - "제 모든 존경심을 담아 말씀드리지만, 헌법에 명시된 제 임무는 선거인단을 인증하는 것입니다"
    - "이 문제에 대해서는 먼저 기도하고, 아내와 상의한 후, 헌법을 검토한 뒤에 입장을 밝히도록 하겠습니다."`
};
